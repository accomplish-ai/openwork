<p align="center">
  <strong>English</strong> | <strong><a href="docs/README.zh.md">中文</a></strong>
</p>
...
| **2** | **Connect Your AI** | Use your own Google, OpenAI, Anthropic (or other) API key. No subscriptions. |
