...
import { getLanguage, setLanguage, type UILanguage } from '@accomplish_ai/agent-core';
...
describe('Language Settings Storage', () => {
  ...
  describe('setLanguage', () => {
    it('should execute UPDATE SQL with language value', () => {
      setLanguage('zh-CN');
      expect(mockPrepare).toHaveBeenCalledWith('UPDATE app_settings SET language = ? WHERE id = 1');
