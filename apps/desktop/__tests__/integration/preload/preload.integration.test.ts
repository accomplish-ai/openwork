  ...
  describe('IPC Method Invocations', () => {
    ...
    describe('Task Operations', () => {
      ...
      it('removeFavorite should invoke task:favorite:remove with taskId', async () => {
        await (capturedAccomplishAPI.removeFavorite as (taskId: string) => Promise<void>)('task_123');
      ...
      it('isFavorite should invoke task:favorite:has with taskId', async () => {
        await (capturedAccomplishAPI.isFavorite as (taskId: string) => Promise<boolean>)('task_123');
