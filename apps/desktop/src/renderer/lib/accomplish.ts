...
interface AccomplishAPI {
  ...
  addApiKey(provider: 'anthropic' | 'openai' | 'openrouter' | 'google' | 'google-vertex-ai' | 'xai' | 'deepseek' | 'moonshot' | 'zai' | 'azure-foundry' | 'custom' | 'bedrock' | 'litellm' | 'lmstudio' | 'elevenlabs', key: string, label?: string): Promise<ApiKeyConfig>;
