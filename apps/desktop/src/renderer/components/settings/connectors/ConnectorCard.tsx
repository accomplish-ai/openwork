      ...
      <div className="flex items-start justify-between gap-3">
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-center gap-2">
            ...
            {/* Status badge */}
            <span className={`flex items-center gap-1 text-[11px] ${statusTextClass[connector.status]}`}>
              <span className={`inline-block h-1.5 w-1.5 rounded-full ${statusDotClass[connector.status]}`} />
              {statusLabel}
            </span>
          </div>
