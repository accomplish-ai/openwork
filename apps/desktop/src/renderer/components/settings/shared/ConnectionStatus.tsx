...
export function ConnectionStatus({ status, onDisconnect }: ConnectionStatusProps) {
  ...
  if (status === 'connecting') {
    return (
      <div className="flex items-center gap-2 text-sm text-muted-foreground" data-testid="connection-status" data-status="connecting">
  ...
  if (status === 'error') {
    return (
      <div className="flex items-center gap-2 text-sm text-destructive" data-testid="connection-status" data-status="error">
  ...
  return (
    <div className="flex items-center gap-2" data-testid="connection-status" data-status="connected">
      <button
