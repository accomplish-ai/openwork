...
interface SettingsDialogProps {
   ...
   */
  initialTab?: 'providers' | 'connectors' | 'integrations' | 'voice' | 'skills' | 'appearance' | 'about';
}
...
export default function SettingsDialog({
  ...
  const [activeTab, setActiveTab] = useState<'providers' | 'connectors' | 'integrations' | 'voice' | 'skills' | 'appearance' | 'about'>(initialTab);
