...
const accomplishAPI = {
  ...
  i18n: {
    getLanguage: (): Promise<'en' | 'zh-CN' | 'auto'> => ipcRenderer.invoke('i18n:get-language'),
    ...
    getResolvedLanguage: (): Promise<string> => ipcRenderer.invoke('i18n:get-resolved-language'),
