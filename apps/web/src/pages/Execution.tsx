...
import { XCircle, CornerDownLeft, ArrowLeft, CheckCircle2, AlertCircle, Clock, Square, Play, Download, ChevronDown } from 'lucide-react';
...
export function ExecutionPage() {
  ...
  const handlePermissionResponse = async (allowed: boolean, selectedOpts?: string[], customText?: string) => {
