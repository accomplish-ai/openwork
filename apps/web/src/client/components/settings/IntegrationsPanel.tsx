        ...
        return (
          ...
          >
            <button
              ...
              aria-expanded={platform.available ? isExpanded : undefined}
              aria-controls={platform.available ? panelId : undefined}
              className="w-full flex items-center justify-between p-4 text-left hover:bg-muted/30 transition-colors disabled:cursor-not-allowed focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/50"
            >
                ...
                {integration && (
                  <div className="pt-2 border-t border-border">
                    <button
                      ...
                      disabled={saving}
                      className="text-sm font-medium text-destructive hover:bg-destructive/10 rounded-md px-3 py-1.5 disabled:pointer-events-none disabled:opacity-50"
                    >
