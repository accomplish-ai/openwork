...
import { Key, Lightning, Microphone, Info, Plugs, Cube } from '@phosphor-icons/react';
...
const TABS = [
  ...
  { id: 'sandbox' as const, labelKey: 'tabs.sandbox', icon: Cube },
...
interface SettingsDialogProps {
   ...
   */
  initialTab?: 'providers' | 'voice' | 'skills' | 'connectors' | 'sandbox' | 'about';
}
...
export function SettingsDialog({
  ...
  const [activeTab, setActiveTab] = useState<
    'providers' | 'voice' | 'skills' | 'connectors' | 'sandbox' | 'about'
  >(initialTab);
