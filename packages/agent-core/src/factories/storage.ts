...
export function createStorage(options: StorageOptions = {}): StorageAPI {
  ...
  return {
    ...
    storeCloudBrowserCredentials: (credentials) => secureStorage.storeCloudBrowserCredentials(credentials),
    getCloudBrowserCredentials: () => secureStorage.getCloudBrowserCredentials(),
